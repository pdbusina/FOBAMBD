...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {(process.env.NODE_ENV === 'development' || window.location.hostname === 'localhost') && debugInfo.projectId && debugInfo.projectId !== "SU_PROJECT_ID" && (
...
const MatriculacionTab = ({ db, appId, showMessage, instrumentos, matriculaciones, snapshotToArray }) => {
    ...
    // (FIX 1) Filtrar matriculaciones del año actual para el listado
